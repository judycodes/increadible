...
|:-------------------------------------------------------:|:-------------------:|:---------------------------------------------:|:-------------------------------------------------------:|:-----:|:-----:|:-----:|:-----:|
| User & Reflection - Model/Service/Repository/Controller | ERD Design          | Microservices Debugging                       | Update reflection subject and tidbit methods functional |       |       |       |       |
| Checked User & Reflection Endpoints (with Postman)      | README.md Created   | Restarting Spring Boot Monolith               | React Routing basic setup                               |       |       |       |       |
| Spring Boot, Microservices, Github Setup                | Wireframing         | Add goal, update goal, and get goal from User | User stories created                                    |       |       |       |       |
| Research & Application Brainstorming                    | Microservices Error | Create React basic template                   |                                                         |       |       |       |       |